...
@endsection
@section('title')
<h1 class="topnav-heading">Update Product</h1>
@endsection
...
@section('content')
    ...
    @component('components.admin.content-box') 
        ...
        @endslot
    @endcomponent
    @include('partials.modals.product-images-update-modal');  
@endsection
...
<script type="text/javascript" src="{{ asset('js/admin/products.images.update.js') }}"></script>
